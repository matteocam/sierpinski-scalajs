...
function $s_sc_TraversableOnce$class__addString__sc_TraversableOnce__scm_StringBuilder__T__T__T__scm_StringBuilder($$this, b, start, sep, end) {
  ...
  $$this.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(first$2, b$2, sep$1) {
    return (function(x$2) {
      if (first$2.elem$1) {
...
/** @constructor */
function $c_Lsierpinski_Sierpinski$() {
  $c_O.call(this);
  this.fact$1 = 0.0;
  this.smallestDim$1 = 0;
  this.totWdt$1 = 0;
  this.totHgt$1 = 0;
  this.animating$1 = false
}
$c_Lsierpinski_Sierpinski$.prototype = new $h_O();
$c_Lsierpinski_Sierpinski$.prototype.constructor = $c_Lsierpinski_Sierpinski$;
/** @constructor */
function $h_Lsierpinski_Sierpinski$() {
  /*<skip>*/
}
$h_Lsierpinski_Sierpinski$.prototype = $c_Lsierpinski_Sierpinski$.prototype;
$c_Lsierpinski_Sierpinski$.prototype.init___ = (function() {
  $n_Lsierpinski_Sierpinski$ = this;
  this.fact$1 = 0.866025403;
  var x = $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerWidth);
  var y = $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerHeight);
  this.smallestDim$1 = ((x < y) ? x : y);
  this.totWdt$1 = $doubleToInt((0.9 * this.smallestDim$1));
  this.totHgt$1 = $doubleToInt((this.fact$1 * this.totWdt$1));
  this.animating$1 = false;
  return this
});
$c_Lsierpinski_Sierpinski$.prototype.fillBlackUpwardTriangle$1__p1__I__I__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(rootX, rootY, base, height, ctx$1) {
  var botLeftX = ((rootX - ((base / 2) | 0)) | 0);
  var botLeftY = ((rootY + height) | 0);
  var botRightX = ((rootX + ((base / 2) | 0)) | 0);
  ctx$1.fillStyle = "black";
  ctx$1.beginPath();
  ctx$1.moveTo(rootX, rootY);
  ctx$1.lineTo(botLeftX, botLeftY);
  ctx$1.lineTo(botRightX, botLeftY);
  ctx$1.closePath();
  ctx$1.fill()
});
$c_Lsierpinski_Sierpinski$.prototype.triangleWdt__Lsierpinski_Sierpinski$Triangle__D = (function(t) {
  if ($is_Lsierpinski_Sierpinski$FullTriangle(t)) {
    var x3 = $as_Lsierpinski_Sierpinski$FullTriangle(t);
    var w = x3.w$2;
    return w
  } else if ($is_Lsierpinski_Sierpinski$PiercedTriangle(t)) {
    var x4 = $as_Lsierpinski_Sierpinski$PiercedTriangle(t);
    var inTriangle = x4.inTriangle$2;
    return (2 * this.triangleWdt__Lsierpinski_Sierpinski$Triangle__D(inTriangle))
  } else {
    throw new $c_s_MatchError().init___O(t)
  }
});
$c_Lsierpinski_Sierpinski$.prototype.pierceSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(t, curX, curY, ctx$1) {
  x: {
    _pierceSierpinski: while (true) {
      var x1 = t;
      if ((!$is_Lsierpinski_Sierpinski$FullTriangle(x1))) {
        if ($is_Lsierpinski_Sierpinski$PiercedTriangle(x1)) {
          var x5 = $as_Lsierpinski_Sierpinski$PiercedTriangle(x1);
          var inTriangle = x5.inTriangle$2;
          this.fillWhiteDownwardTriangle$1__p1__I__I__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(curX, ((curY + $doubleToInt(this.triangleHgt__Lsierpinski_Sierpinski$Triangle__D(t))) | 0), $doubleToInt(this.triangleWdt__Lsierpinski_Sierpinski$Triangle__D(inTriangle)), $doubleToInt(this.triangleHgt__Lsierpinski_Sierpinski$Triangle__D(inTriangle)), ctx$1);
          this.pierceSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(inTriangle, curX, curY, ctx$1);
          var delta = $doubleToInt((this.triangleWdt__Lsierpinski_Sierpinski$Triangle__D(inTriangle) / 2));
          var midTriangleY = ((curY + $doubleToInt(this.triangleHgt__Lsierpinski_Sierpinski$Triangle__D(inTriangle))) | 0);
          this.pierceSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(inTriangle, ((curX - delta) | 0), midTriangleY, ctx$1);
          var temp$curX = ((curX + delta) | 0);
          t = inTriangle;
          curX = temp$curX;
          curY = midTriangleY;
          continue _pierceSierpinski
        } else {
...
$c_Lsierpinski_Sierpinski$.prototype.genTriangleBtnClicked__V = (function() {
  if (this.animating$1) {
    return (void 0)
  };
  var canvas = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("canvas");
  var ctx = canvas.getContext("2d");
  ctx.clearRect(0.0, 0.0, $uI(canvas.width), $uI(canvas.height));
  var numInput = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("numIterations");
  var x = $as_T(numInput.value);
  var this$2 = new $c_sci_StringOps().init___T(x);
  var this$4 = $m_jl_Integer$();
  var $$this = this$2.repr$1;
  var n = this$4.parseInt__T__I__I($$this, 10);
  var allTrianglesCheckbox = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("allValues");
  var shouldShowAllTriangles = $uZ(allTrianglesCheckbox.checked);
  if (shouldShowAllTriangles) {
    this.drawAllSierpinksisUpTo$1__p1__I__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(n, canvas, ctx)
  } else {
    var t = this.buildSierpinskiTriangle__I__Lsierpinski_Sierpinski$Triangle(n);
    this.drawSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(t, ctx)
  }
});
$c_Lsierpinski_Sierpinski$.prototype.$$js$exported$meth$genTriangleBtnClicked__O = (function() {
  this.genTriangleBtnClicked__V()
});
$c_Lsierpinski_Sierpinski$.prototype.fillWhiteDownwardTriangle$1__p1__I__I__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(rootX, rootY, base, height, ctx$1) {
  var topLeftX = ((rootX - ((base / 2) | 0)) | 0);
  var topLeftY = ((rootY - height) | 0);
  var topRightX = ((rootX + ((base / 2) | 0)) | 0);
  ctx$1.fillStyle = "white";
  ctx$1.beginPath();
  ctx$1.moveTo(rootX, rootY);
  ctx$1.lineTo(topLeftX, topLeftY);
  ctx$1.lineTo(topRightX, topLeftY);
  ctx$1.closePath();
  ctx$1.fill()
});
$c_Lsierpinski_Sierpinski$.prototype.drawSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(t, ctx$1) {
  var startX = $doubleToInt(($uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerWidth) / 1.9));
  var startY = (($uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerHeight) / 20) | 0);
  this.fillBlackUpwardTriangle$1__p1__I__I__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(startX, startY, $doubleToInt(this.triangleWdt__Lsierpinski_Sierpinski$Triangle__D(t)), $doubleToInt(this.triangleHgt__Lsierpinski_Sierpinski$Triangle__D(t)), ctx$1);
  this.pierceSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__I__I__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(t, startX, startY, ctx$1)
});
$c_Lsierpinski_Sierpinski$.prototype.buildSierpinskiTriangle__I__Lsierpinski_Sierpinski$Triangle = (function(n) {
  if ((n > 6)) {
    var alpha = (0.44 * (((-3) + n) | 0));
    return this.buildSierpinskiTriangle$und__I__D__D__Lsierpinski_Sierpinski$Triangle(n, $doubleToInt((this.totWdt$1 * alpha)), $doubleToInt((this.totHgt$1 * alpha)))
  } else {
    return this.buildSierpinskiTriangle$und__I__D__D__Lsierpinski_Sierpinski$Triangle(n, this.totWdt$1, this.totHgt$1)
  }
});
$c_Lsierpinski_Sierpinski$.prototype.triangleHgt__Lsierpinski_Sierpinski$Triangle__D = (function(t) {
  if ($is_Lsierpinski_Sierpinski$FullTriangle(t)) {
    var x3 = $as_Lsierpinski_Sierpinski$FullTriangle(t);
    var h = x3.h$2;
    return h
    ...
    var x4 = $as_Lsierpinski_Sierpinski$PiercedTriangle(t);
    var inTriangle = x4.inTriangle$2;
    return (2 * this.triangleHgt__Lsierpinski_Sierpinski$Triangle__D(inTriangle))
  } else {
    throw new $c_s_MatchError().init___O(t)
  }
});
$c_Lsierpinski_Sierpinski$.prototype.buildSierpinskiTriangle$und__I__D__D__Lsierpinski_Sierpinski$Triangle = (function(n, w, h) {
  switch (n) {
    case 0: {
      return new $c_Lsierpinski_Sierpinski$FullTriangle().init___D__D(w, h);
      break
    }
    default: {
      var newTriangle = this.buildSierpinskiTriangle$und__I__D__D__Lsierpinski_Sierpinski$Triangle((((-1) + n) | 0), (w / 2), (h / 2));
      return new $c_Lsierpinski_Sierpinski$PiercedTriangle().init___Lsierpinski_Sierpinski$Triangle(newTriangle)
    }
  }
});
$c_Lsierpinski_Sierpinski$.prototype.sierpinski$Sierpinski$$drawAndPostpone$1__I__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__V = (function(i, canvas$1, ctx$1, n$1) {
  ctx$1.clearRect(0.0, 0.0, $uI(canvas$1.width), $uI(canvas$1.height));
  var t = this.buildSierpinskiTriangle__I__Lsierpinski_Sierpinski$Triangle(i);
  this.drawSierpinski$1__p1__Lsierpinski_Sierpinski$Triangle__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(t, ctx$1);
  if ((i < n$1)) {
    $m_sjs_js_timers_package$().setTimeout__D__F0__sjs_js_timers_SetTimeoutHandle(700.0, new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(canvas$1$1, ctx$1$1, n$1$1, i$1) {
      return (function() {
        $m_Lsierpinski_Sierpinski$().sierpinski$Sierpinski$$drawAndPostpone$1__I__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__V(((1 + i$1) | 0), canvas$1$1, ctx$1$1, n$1$1)
      })
    })(canvas$1, ctx$1, n$1, i)))
  } else {
    this.animating$1 = false
  }
});
$c_Lsierpinski_Sierpinski$.prototype.drawAllSierpinksisUpTo$1__p1__I__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(n, canvas$1, ctx$1) {
  this.animating$1 = true;
  this.sierpinski$Sierpinski$$drawAndPostpone$1__I__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__I__V(0, canvas$1, ctx$1, n)
});
$c_Lsierpinski_Sierpinski$.prototype.genTriangleBtnClicked = (function() {
  return this.$$js$exported$meth$genTriangleBtnClicked__O()
});
var $d_Lsierpinski_Sierpinski$ = new $TypeData().initClass({
  Lsierpinski_Sierpinski$: 0
}, false, "sierpinski.Sierpinski$", {
  Lsierpinski_Sierpinski$: 1,
  O: 1
});
$c_Lsierpinski_Sierpinski$.prototype.$classData = $d_Lsierpinski_Sierpinski$;
var $n_Lsierpinski_Sierpinski$ = (void 0);
function $m_Lsierpinski_Sierpinski$() {
  if ((!$n_Lsierpinski_Sierpinski$)) {
    $n_Lsierpinski_Sierpinski$ = new $c_Lsierpinski_Sierpinski$().init___()
  };
  return $n_Lsierpinski_Sierpinski$
}
$e.sierpinski = ($e.sierpinski || {});
$e.sierpinski.Sierpinski = $m_Lsierpinski_Sierpinski$;
/** @constructor */
function $c_Lsierpinski_Sierpinski$Triangle() {
  $c_O.call(this)
}
$c_Lsierpinski_Sierpinski$Triangle.prototype = new $h_O();
$c_Lsierpinski_Sierpinski$Triangle.prototype.constructor = $c_Lsierpinski_Sierpinski$Triangle;
/** @constructor */
function $h_Lsierpinski_Sierpinski$Triangle() {
  /*<skip>*/
}
$h_Lsierpinski_Sierpinski$Triangle.prototype = $c_Lsierpinski_Sierpinski$Triangle.prototype;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
$c_s_util_hashing_MurmurHash3.prototype.orderedHash__sc_TraversableOnce__I__I = (function(xs, seed) {
  ...
  xs.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, n$2, h$1) {
    return (function(x$2) {
      h$1.elem$1 = arg$outer.mix__I__I__I(h$1.elem$1, $m_sr_ScalaRunTime$().hash__O__I(x$2));
...
$c_s_StringContext$.prototype.treatEscapes__T__T = (function(str) {
  ...
  while ((elem$1$4 < len)) {
    elem$1$3 = elem$1$4;
    var index = elem$1$4;
    if (((65535 & $uI(str.charCodeAt(index))) === 92)) {
      elem$1$4 = ((1 + elem$1$4) | 0);
      if ((elem$1$4 >= len)) {
        throw new $c_s_StringContext$InvalidEscapeException().init___T__I(str, elem$1$3)
      };
      var index$1 = elem$1$4;
      if (((65535 & $uI(str.charCodeAt(index$1))) >= 48)) {
        var index$2 = elem$1$4;
        var jsx$1 = ((65535 & $uI(str.charCodeAt(index$2))) <= 55)
      } else {
        var jsx$1 = false
      };
      if (jsx$1) {
        var index$3 = elem$1$4;
        var leadch = (65535 & $uI(str.charCodeAt(index$3)));
        var oct = (((-48) + leadch) | 0);
        elem$1$4 = ((1 + elem$1$4) | 0);
        if ((elem$1$4 < len)) {
          var index$4 = elem$1$4;
          var jsx$3 = ((65535 & $uI(str.charCodeAt(index$4))) >= 48)
        } else {
          var jsx$3 = false
        };
        if (jsx$3) {
          var index$5 = elem$1$4;
          var jsx$2 = ((65535 & $uI(str.charCodeAt(index$5))) <= 55)
        } else {
          var jsx$2 = false
        };
        if (jsx$2) {
          ...
          oct = (((-48) + (($imul(8, jsx$4) + (65535 & $uI(str.charCodeAt(index$6)))) | 0)) | 0);
          elem$1$4 = ((1 + elem$1$4) | 0);
          if (((elem$1$4 < len) && (leadch <= 51))) {
            var index$7 = elem$1$4;
            var jsx$6 = ((65535 & $uI(str.charCodeAt(index$7))) >= 48)
          } else {
            var jsx$6 = false
          };
          if (jsx$6) {
            var index$8 = elem$1$4;
            var jsx$5 = ((65535 & $uI(str.charCodeAt(index$8))) <= 55)
          } else {
            var jsx$5 = false
          };
          if (jsx$5) {
            ...
            oct = (((-48) + (($imul(8, jsx$7) + (65535 & $uI(str.charCodeAt(index$9)))) | 0)) | 0);
            elem$1$4 = ((1 + elem$1$4) | 0)
          }
        };
        var ch = (65535 & oct);
        if (((1 & elem$1$1) === 0)) {
          if (((1 & elem$1$1) === 0)) {
            elem$1 = new $c_jl_StringBuilder().init___();
            elem$1$1 = (1 | elem$1$1)
          };
          var jsx$8 = $as_jl_StringBuilder(elem$1)
        } else {
          var jsx$8 = $as_jl_StringBuilder(elem$1)
        };
        ...
        if (((1 & elem$1$1) === 0)) {
          ...
          var jsx$9 = $as_jl_StringBuilder(elem$1)
        } else {
          var jsx$9 = $as_jl_StringBuilder(elem$1)
        };
        ...
        var ch$1 = (65535 & $uI(str.charCodeAt(index$10)));
        elem$1$4 = ((1 + elem$1$4) | 0);
        switch (ch$1) {
          case 98: {
            var ch$2 = 8;
        ...
        if (((1 & elem$1$1) === 0)) {
          ...
          var jsx$10 = $as_jl_StringBuilder(elem$1)
        } else {
          var jsx$10 = $as_jl_StringBuilder(elem$1)
        };
        ...
        if (((1 & elem$1$1) === 0)) {
          ...
          var jsx$11 = $as_jl_StringBuilder(elem$1)
        } else {
          var jsx$11 = $as_jl_StringBuilder(elem$1)
        };
  ...
  if ((elem$1$2 === 0)) {
    ...
    if (((1 & elem$1$1) === 0)) {
      ...
      var jsx$12 = $as_jl_StringBuilder(elem$1)
    } else {
      var jsx$12 = $as_jl_StringBuilder(elem$1)
    };
...
function $is_jl_StringBuilder(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.jl_StringBuilder)))
}
function $as_jl_StringBuilder(obj) {
  return (($is_jl_StringBuilder(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "java.lang.StringBuilder"))
}
function $isArrayOf_jl_StringBuilder(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.jl_StringBuilder)))
}
function $asArrayOf_jl_StringBuilder(obj, depth) {
  return (($isArrayOf_jl_StringBuilder(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ljava.lang.StringBuilder;", depth))
}
...
$c_s_MatchError.prototype.liftedTree1$1__p4__T = (function() {
  try {
    ...
    $m_sjsr_package$().wrapJavaScriptException__O__jl_Throwable(e);
...
$c_s_StringContext.prototype.checkLengths__sc_Seq__V = (function(args) {
  if ((this.parts$1.length__I() !== ((1 + args.length__I()) | 0))) {
    throw new $c_jl_IllegalArgumentException().init___T("wrong number of arguments for interpolated string")
  }
});
...
/** @constructor */
function $c_Lsierpinski_Sierpinski$FullTriangle() {
  $c_Lsierpinski_Sierpinski$Triangle.call(this);
  this.w$2 = 0.0;
  this.h$2 = 0.0
}
$c_Lsierpinski_Sierpinski$FullTriangle.prototype = new $h_Lsierpinski_Sierpinski$Triangle();
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.constructor = $c_Lsierpinski_Sierpinski$FullTriangle;
/** @constructor */
function $h_Lsierpinski_Sierpinski$FullTriangle() {
  /*<skip>*/
}
$h_Lsierpinski_Sierpinski$FullTriangle.prototype = $c_Lsierpinski_Sierpinski$FullTriangle.prototype;
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.productPrefix__T = (function() {
  return "FullTriangle"
});
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.productArity__I = (function() {
  return 2
});
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.w$2;
      break
...
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.init___D__D = (function(w, h) {
  this.w$2 = w;
  this.h$2 = h;
  return this
});
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.w$2));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.h$2));
  return $m_sr_Statics$().finalizeHash__I__I__I(acc, 2)
});
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lsierpinski_Sierpinski$FullTriangle(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lsierpinski_Sierpinski$FullTriangle)))
}
function $as_Lsierpinski_Sierpinski$FullTriangle(obj) {
  return (($is_Lsierpinski_Sierpinski$FullTriangle(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "sierpinski.Sierpinski$FullTriangle"))
}
function $isArrayOf_Lsierpinski_Sierpinski$FullTriangle(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lsierpinski_Sierpinski$FullTriangle)))
}
function $asArrayOf_Lsierpinski_Sierpinski$FullTriangle(obj, depth) {
  return (($isArrayOf_Lsierpinski_Sierpinski$FullTriangle(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lsierpinski.Sierpinski$FullTriangle;", depth))
}
var $d_Lsierpinski_Sierpinski$FullTriangle = new $TypeData().initClass({
  Lsierpinski_Sierpinski$FullTriangle: 0
}, false, "sierpinski.Sierpinski$FullTriangle", {
  Lsierpinski_Sierpinski$FullTriangle: 1,
  Lsierpinski_Sierpinski$Triangle: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lsierpinski_Sierpinski$FullTriangle.prototype.$classData = $d_Lsierpinski_Sierpinski$FullTriangle;
/** @constructor */
function $c_Lsierpinski_Sierpinski$PiercedTriangle() {
  $c_Lsierpinski_Sierpinski$Triangle.call(this);
  this.inTriangle$2 = null
}
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype = new $h_Lsierpinski_Sierpinski$Triangle();
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.constructor = $c_Lsierpinski_Sierpinski$PiercedTriangle;
/** @constructor */
function $h_Lsierpinski_Sierpinski$PiercedTriangle() {
  /*<skip>*/
}
$h_Lsierpinski_Sierpinski$PiercedTriangle.prototype = $c_Lsierpinski_Sierpinski$PiercedTriangle.prototype;
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.productPrefix__T = (function() {
  return "PiercedTriangle"
});
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.productArity__I = (function() {
  return 1
});
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.inTriangle$2;
      break
    }
    default: {
      throw new $c_jl_IndexOutOfBoundsException().init___T(("" + x$1))
...
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.init___Lsierpinski_Sierpinski$Triangle = (function(inTriangle) {
  this.inTriangle$2 = inTriangle;
  return this
});
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
function $is_Lsierpinski_Sierpinski$PiercedTriangle(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lsierpinski_Sierpinski$PiercedTriangle)))
}
function $as_Lsierpinski_Sierpinski$PiercedTriangle(obj) {
  return (($is_Lsierpinski_Sierpinski$PiercedTriangle(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "sierpinski.Sierpinski$PiercedTriangle"))
}
function $isArrayOf_Lsierpinski_Sierpinski$PiercedTriangle(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lsierpinski_Sierpinski$PiercedTriangle)))
}
function $asArrayOf_Lsierpinski_Sierpinski$PiercedTriangle(obj, depth) {
  return (($isArrayOf_Lsierpinski_Sierpinski$PiercedTriangle(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lsierpinski.Sierpinski$PiercedTriangle;", depth))
}
var $d_Lsierpinski_Sierpinski$PiercedTriangle = new $TypeData().initClass({
  Lsierpinski_Sierpinski$PiercedTriangle: 0
}, false, "sierpinski.Sierpinski$PiercedTriangle", {
  Lsierpinski_Sierpinski$PiercedTriangle: 1,
  Lsierpinski_Sierpinski$Triangle: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Lsierpinski_Sierpinski$PiercedTriangle.prototype.$classData = $d_Lsierpinski_Sierpinski$PiercedTriangle;
/** @constructor */
...
$c_s_StringContext$InvalidEscapeException.prototype.init___T__I = (function(str, idx) {
  var s = (((("invalid escape character at index " + idx) + " in \"") + str) + "\"");
  $c_jl_Throwable.prototype.init___T__jl_Throwable.call(this, s, null);
  return this
});
...
//# sourceMappingURL=sierpinski-fastopt.js.map
